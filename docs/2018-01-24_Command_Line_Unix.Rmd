...
drwxr-xr-x. 2 srkeller users  6 Jan 31 17:15 myscripts
[srkeller@pbio381 ~]$ 
```
...
- You'll notive that I've got some extra folders in my output from previous work, whereas you will probably only see the "myscripts" folder you just made. 
  ...
  - Try making your own folder named "mydata" and then use the **ll** command to list the folders again 
...
- Hah — nothing in there yet! Let's go get some data!
  - We've placed the text file containing some metadata information on the RNA-Seq dataset we will be analyzing for the first half of the semester. We put this under a shared space on the server. The path to this shared space is: 
