...
The papers we've read report on some very intriguing associations between species life history traits, nucleotide diversity at synonymous sites (piS), and the efficacy of selection measured as the ratio of piN/piS (where piN is nucleotide diversity at nonsynonymous site). Remember, higher values of PiN/piS mean selection is LESS effective at clearing deleterious mutations, probably due to small Ne.
...
[srkeller@pbio381 reads2snps]$ /data/popgen/dNdSpiNpiS_1.0 -alignment_file=OTAU_2018_reads2snps.fas -ingroup=sp --contigs=even (or odd) --bs_replicates=100
```
